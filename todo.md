...
- [ ] Implement add/edit/delete property functionality
...
- [ ] Add amenities multi-select filter
- [ ] Build filter persistence and URL state
...
- [ ] Create admin dashboard for viewing management
